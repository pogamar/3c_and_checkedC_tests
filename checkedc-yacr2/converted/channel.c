...
DescribeChannel(void)
{
     ...
     */
    BOT = (_Array_ptr<unsigned long>)malloc((channelColumns+1) * sizeof(ulong));
...
DensityChannel(void)
{
     ...
     */
    FIRST = (_Array_ptr<unsigned long>)malloc((channelNets+1) * sizeof(ulong));
    LAST = (_Array_ptr<unsigned long>)malloc((channelNets+1) * sizeof(ulong));
    DENSITY = (_Array_ptr<unsigned long>)malloc((channelColumns+1) * sizeof(ulong));
    CROSSING = (_Array_ptr<unsigned long>)malloc((channelNets+1) * sizeof(ulong));
